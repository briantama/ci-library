...
<!-- DataTales Example -->
          <div class="card shadow mb-4">
            ...
            <div class="card-body">  
              <form method="post" action="" name="r_borrowing" id="r_borrowing" enctype="multipart/form-data">
              ...
              <table class="table table-sm table-form" style="overflow:auto;">
                ...
                <tr>
                  ...
                  <td style="width: 35%"><input class="form-control" id="bookname" name="booknames" type="text" required readonly="readonly" /></td>
                </tr>
                 <tr>
                  <td style="width: 15%">Borrowing ID *</td>
                  <td style="width: 35%"><input class="form-control" id="borrowing" name="borrowing" type="text" required /></td>
                  <td style="width: 15%">Status *</td>
                  <td style="width: 75%">
                       <select name="status" id="status" class="form-control">
                            <option value="">All</option>
                            <option value="1"><span class='badge badge-danger'>Active</span></option>
                            <option value="5"><span class='badge badge-warning'>OnGoing</span></option>
                            <option value="7"><span class='badge badge-success'>Finish</span></option>
                        </select>
                    </td>
                </tr>
               <tr>
                  <td colspan="4" align="left">
                     <button type="button" class="btn btn-warning" onclick="callpage('reportborrowing/viewReportborrowing', '', '')"><i class="fas fa-fw fa-eraser"></i> Reset</button>
                     <button type="button" class="btn btn-primary" onclick="return ReportSearch('r_borrowing', 'reportborrowing/viewReportborrowing/view');"><i class="fas fa-fw fa-search"></i> Search</button>
                  </td>
                </tr>
              </table>
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <div id="content-rpt">
                  <?php $this->load->view('reportborrowing/Reportborrowing_search', array('keys'=>$str)); ?>
                </div>
