...
<div class='wrap-cap'>
<div class='cap' style='text-align: center; font-weight: bold;'>Report Bookshelf<br/ >Effective Date : <?php echo date('d M Y'); ?>
</div>
</div>
</div>
        ...
        <table border='1' class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
         <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td colspan="10" style="text-align: center;">No Data Bookshelf</td>
                    </tr>
