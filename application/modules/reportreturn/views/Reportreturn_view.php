...
<!-- DataTales Example -->
          <div class="card shadow mb-4">
            ...
            <div class="card-body">  
              <form method="post" action="" name="r_return" id="r_return" enctype="multipart/form-data">
              <div id="notif-rpt"></div>
              <div class="table-responsive">
              <table class="table table-sm table-form" style="overflow:auto;">
                <tr>
                  <td style="width: 15%">ReturnBook ID * <br><div id="viewinfo"></div></td>
                  <td style="width: 35%"><input class="form-control" id="return" name="return" type="text" required /></td>
                  <td style="width: 15%">BorrowingID *</td>
               ...
               <tr>
                  <td colspan="4" align="left">
                     <button type="button" class="btn btn-warning" onclick="callpage('reportreturn/viewReportreturn', '', '')"><i class="fas fa-fw fa-eraser"></i> Reset</button>
                     <button type="button" class="btn btn-primary" onclick="return ReportSearch('r_return', 'reportreturn/viewReportreturn/view');"><i class="fas fa-fw fa-search"></i> Search</button>
                  </td>
                </tr>
              </table>
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <div id="content-rpt">
                  <?php $this->load->view('reportreturn/Reportreturn_search', array('keys'=>$str)); ?>
                </div>
