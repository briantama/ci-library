...
<div class='wrap-cap'>
<div class='cap' style='text-align: center; font-weight: bold;'>Report Borrowers<br/ >Effective Date : <?php echo date('d M Y'); ?>
</div>
</div>
</div>
         ...
         <thead>
                  ...
                  <tbody>
                    ...
                    ?>
                     ...
                     <tr>
                      <td colspan="15" style="text-align: center;">No Data Borrower</td>
                    </tr>
